---
название: "Новости ИИ/технологий"
...
Большой языково-визуальный помощник, созданный с учетом мультимодальных возможностей уровня GPT-4.
https://github.com/haotian-liu/LLaVA

Семейство фундаментных моделей, производящих универсальные признаки, пригодные как для визуальных задач на уровне изображений (классификация изображений, поиск экземпляров, понимание видео), так и для визуальных задач на уровне пикселей (оценка глубины, семантическая сегментация).
