...
Asisten Bahasa dan Penglihatan yang besar yang dibangun untuk mencapai kemampuan tingkat GPT-4 multimodal.
https://github.com/haotian-liu/LLaVA

Rangkaian model dasar yang menghasilkan fitur universal yang cocok untuk tugas visual tingkat gambar (klasifikasi gambar, pengambilan contoh, pemahaman video) serta tugas visual tingkat piksel (estimasi kedalaman, segmentasi semantik).
...
0418
```
人人都可拥有自主性AI：有记忆会使用工具，还会自我学习！底层自研框架即将开源
...
Harga tiket pesawat di atas 1 juta rupiah
```
0331
```
...
https://medium.com/@imicknl/cara-membuat-chatgpt-pribadi-dengan-data-mu-15754e6378a1
