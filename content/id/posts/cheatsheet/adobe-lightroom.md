...
Pintasan | Tindakan
---|---
`F11` | Membuka jendela sekunder
`Shift` `G` | Masuk ke tampilan Kisi
`Shift` `E` | Masuk ke tampilan Loupe normal
`Ctrl` `Shift` `Enter` | Masuk ke tampilan Loupe yang terkunci
`Shift` `C` | Masuk ke tampilan Perbandingan
`Shift` `N` | Masuk ke tampilan Survei
`Ctrl` `Alt` `Shift` `Enter` | Masuk ke tampilan Slideshow
`Shift` `F11` | Masuk ke mode layar penuh (memerlukan monitor kedua)
`Shift` `\` | Menampilkan/menyembunyikan bilah Filter
`Ctrl` `Shift` `+/-` | Memperbesar/memperkecil
{.shortcuts}



### Bekerja di modul Develop {.row-span-3}

Pintasan | Tindakan
---|---
`V` | Mengubah ke skala abu-abu
`Ctrl` `U` | Nada otomatis
`Ctrl` `Shift` `U` | Keseimbangan putih otomatis
`Ctrl` `E` | Mengedit di Photoshop
`Ctrl` `Shift` `C/V` | Salin/rekatkan pengaturan Kembangkan
`Ctrl` `Alt` `V` | Menempelkan pengaturan dari foto sebelumnya
`Ctrl` `Alt` `Shift` `Kiri` | Menyalin pengaturan Setelah ke Sebelum
`Ctrl` `Alt` `Shift` `Right` | Menyalin pengaturan Sebelum ke Sesudah
`Ctrl` `Alt` `Shift` `Atas` | Menukar pengaturan Sebelum dan Sesudah
`Atas/Bawah` | Menambah/mengurangi penggeser yang dipilih secara bertahap
`Shift` `Atas/Bawah` | Menambah/mengurangi penggeser yang dipilih dengan kenaikan yang lebih besar
`./,` | Menelusuri pengaturan panel Dasar (maju/mundur)
`(klik dua kali nama penggeser)` | Mengatur ulang penggeser
`Alt` `(klik nama grup)` | Mengatur ulang sekelompok penggeser
`Ctrl` `Shift` `R` | Mengatur ulang semua pengaturan
`Ctrl` `Shift` `S` | Menyelaraskan pengaturan
`Ctrl` `Alt` `S` | Menyinkronkan pengaturan dengan melewati kotak dialog Sinkronisasi Pengaturan
`Ctrl` `(klik tombol Sinkronisasi)` | Alihkan Sinkronisasi Otomatis
`Ctrl` `Alt` `Shift` `A` | Mengaktifkan Sinkronisasi Otomatis
`Ctrl` `Alt` `Shift` `M` | Mencocokkan eksposur total
`W` | Pilih alat White Balance (dari modul apa pun)
`R` | Pilih alat Pangkas (dari modul apa pun)
`A` | Membatasi rasio aspek ketika alat Pangkas dipilih
`Shift` `A` | Memotong ke rasio aspek yang sama dengan pemotongan sebelumnya
`Alt` `(seret)` | Pangkas dari tengah foto
`O` | Hamparan kisi-kisi Pangkas Siklus
`Shift` `O` | Orientasi hamparan kisi-kisi Siklus Pangkas
`X` | Beralih pangkas antara orientasi potret dan lanskap
`Ctrl` `Alt` `R` | Mengatur ulang pemangkasan
`Shift` `T` | Memilih alat Tegak Terpandu
`Q` | Memilih alat Penghapusan Bintik
`Shift` `T` | Alihkan Kuas antara mode Kloning dan Sembuhkan saat alat Penghilang Bintik dipilih
`K` | Pilih alat Kuas Penyesuaian (dari modul apa pun)
`M` | Pilih alat Filter Bertingkat
`Shift` `T` | Beralih Mask antara mode Edit dan Brush saat Filter Bertingkat/Radial dipilih
`]/[` | Menambah/mengurangi ukuran kuas
`Shift` `]/[` | Menambah/mengurangi bulu kuas
`/` | Beralih antara kuas penyesuaian lokal A dan B
`Alt` `(seret)` | Beralih sementara dari kuas A atau B ke Penghapus
`Shift` `(seret)` | Melukis garis horizontal atau vertikal
`H` | Menampilkan/menyembunyikan pin penyesuaian lokal
`O` | Menampilkan/menyembunyikan hamparan topeng penyesuaian lokal
`Shift` `O` | Mengganti warna hamparan topeng penyesuaian lokal
`Ctrl` `Alt` `Shift` `T` | Memilih alat Penyesuaian Target untuk menerapkan penyesuaian Kurva Nada
`Ctrl` `Alt` `Shift` `H` | Pilih alat bantu Penyesuaian Bertarget untuk menerapkan penyesuaian Rona Warna
...
`Alt` `Backspace` | Menghapus foto yang dipilih dari katalog
