...
Pintasan | Aksi
---|---
`X` | Memperbesar 2x (sementara)
`Ctrl` `+` | Memperbesar
`Ctrl` `-` | Memperkecil
`Ctrl` `0` | Menyesuaikan tampilan
`Ctrl` `Z` | Membatalkan tindakan terakhir
`Ctrl` `Shift` `Z` | Mengulang tindakan terakhir
`Ctrl` `D` | Batalkan pilihan semua
`Ctrl` `H` | Menyembunyikan pilihan dan panel
`Panah` | Memindahkan pilihan 1 piksel
`Shift` `Panah` | Memindahkan pilihan 10 piksel
`Ctrl` `C` | Menyalin
`Ctrl` `V` | Menempel
`Ctrl` `Shift` `T` | Mengulangi duplikat dan pemindahan terakhir
`Ctrl` `Alt` `T` | Membuat pilihan mengambang dari pilihan saat ini
`Alt` `Shift` | Membatasi pilihan hingga rotasi 15 derajat
`Backspace` | Menghapus simpul terakhir saat membuat bidang
{.shortcuts}


### Gunakan kotak dialog Camera Raw {.row-span-4}

Pintasan | Tindakan
---|---
`Z` | Alat zoom
`H` | Alat bantu tangan
`I` | Alat keseimbangan putih
`S` | Alat sampel warna
`C` | Alat pangkas
`A` | Alat pelurus
`B` | Alat penghapus bintik
`E` | Alat penghilang mata merah
`Ctrl` `Alt` `1` | Panel dasar
`Ctrl` `Alt` `2` | Panel kurva nada
`Ctrl` `Alt` `3` | Panel detail
`Ctrl` `Alt` `4` | Panel HSL/Skala abu-abu
`Ctrl` `Alt` `5` | Panel nada terpisah
`Ctrl` `Alt` `6` | Panel koreksi lensa
`Ctrl` `Alt` `7` | Panel kalibrasi kamera
`Ctrl` `Alt` `8` | Panel preset
`Ctrl` `Alt` `9` | Panel snapshot terbuka
`Ctrl` `Alt` `Shift` `T` | Alat penyesuaian target kurva parametrik
`Ctrl` `Alt` `Shift` `H` | Alat penyesuaian yang ditargetkan rona
`Ctrl` `Alt` `Shift` `S` | Alat penyesuaian bertarget kejenuhan
`Ctrl` `Alt` `Shift` `L` | Alat penyesuaian dengan target pencahayaan
`Ctrl` `Alt` `Shift` `G` | Alat penyesuaian target campuran skala abu-abu
`T` | Alat penyesuaian bertarget yang terakhir digunakan
`K` | Alat kuas penyesuaian
`G` | Alat filter bertingkat
`Alt` | Beralih sementara dari mode Tambah ke Hapus untuk alat kuas Penyesuaian, atau dari mode Hapus ke Tambah
`Alt` `]/[` | Menambah/mengurangi ukuran alat kuas penyesuaian sementara
`Alt` `Shift` `]/[` | Menambah/mengurangi bulu alat kuas penyesuaian sementara
`Alt` `=/-` | Menambah/mengurangi aliran ukuran alat kuas penyesuaian sementara dengan kenaikan 10
`N` | Beralih ke mode Baru dari mode Tambah atau Hapus alat bantu Kuas Penyesuaian atau filter Lulus
`M` | Alihkan Topeng Otomatis untuk alat Kuas Penyesuaian
`Y` | Alihkan Tampilkan Topeng untuk alat Kuas Penyesuaian
`V` | Beralih pin untuk alat Kuas Penyesuaian
`L` | Memutar gambar ke kiri
`R` | Memutar gambar ke kanan
